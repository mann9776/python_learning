...
KPIs_header = ['RACH_Accessibility_Overall_Success_Rate', 'RRC Setup Success', 'RRE_FAILURE_RATE (DROP RATE)', 'RRC_Reestablishment_Fallback_Success_Rate', 'RRC_ConnMean', 'Conn Max', 'DL MCS QPSK', 'DL MCS 16QAM', 'DL MCS 64QAM', 'DL MCS 256QAM', 'Data_QoS_Flow_5QI9_Setup_Success_Rate', 'UE_Call_Drop_Rate', 'VoNR Call Setup (5QI1)', 'VoNR Drop Rate (5QI1)', 'VoNR Call Setup Time (5QI1)', 'Intra_NR_Overall_Execution_Success_Rate', 'NR_RAN_Cell_Availability_Rate', 'PDUSessionEstSucessRate_Each_Slice', 'RRC_CA_ConnMean', 'CA Call Conn Max', 'DL BLER', 'UL BLER', 'DL PRB %', 'UL PRB %', 'PHY-DL user TPUT', 'PHY-UL user TPUT', 'PAGING DISCARD at CU', 'PAGING DISCARD at DU', 'DynScheduledUeDlMax', 'DynScheduledUeUlMax', 'FiveQI_Abnormal_release_percentage', 'Average_Active_UE_DL_All_QCI', 'Average_Active_UE_UL_All_QCI']
