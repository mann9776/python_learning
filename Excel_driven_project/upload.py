...
file_path = "C:/Users/singhman/Downloads/download.xlsx"
fruit_name = "Mango"
newValue = "400"
...
driver.get("http://www.rahulshettyacademy.com/upload-download-test/index.html")
driver.find_element(By.ID, "downloadButton").click()

#edit the excel utility
update_excel_data(file_path, fruit_name, "price", newValue)

#upload a file from windows, selenium cannot automate windows. To make it work, type should be equal to file as CSS/XPATh selector
